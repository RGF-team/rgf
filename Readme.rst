...
* FastRGF crashes if training dataset is too small (#data < 28).

* FastRGF crashes if sample weights is too small. The value of the weight is dependent on the size of the dataset.
